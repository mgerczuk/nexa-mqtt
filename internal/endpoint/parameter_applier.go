...
type ParameterApplier interface {
	...
	SetAllowGridCharging(device models.NoahDevicePayload, allow bool) error
	SetGridConnectionControl(device models.NoahDevicePayload, offlineEnable bool) error
	SetAcCouplePowerControl(device models.NoahDevicePayload, _1000WEnable bool) error
}
